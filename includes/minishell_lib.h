...
/*   Updated: 2024/07/11 12:42:00 by cyferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					init_check_quote(int *i, int *first_enter, int *flag_s,
							int *flag_d, int *signal);
/**[PROMPT FUNCTIONS]**/
...
void					handle_double_quotes_flush(char *str, char *buffer,
							int *i, int *j, t_data *data, int flag_for_copy);
