...
#    Updated: 2024/06/21 11:32:54 by whamdi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS = ./utils/print_utils.c cleaner.c 
...
TOKENIZER = ./tokenizer/tokenizer.c ./tokenizer/tokenizer_util.c ./tokenizer/split_tokenizer.c ./tokenizer/tokenizer_util_1.c ./tokenizer/count_sign.c /tokenizer/flush_redir.c ./tokenizer/cutting_input.c ./tokenizer/split_pipe_cust.c ./tokenizer/ skip_promptspace.c  
