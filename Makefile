...
#    Updated: 2024/06/24 13:51:41 by cyferrei         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXEC = ./exec/exec.c ./exec/exec_utils.c ./exec/exec_sub_proc.c ./exec/exec_errors.c exec/exec_multi_pipe.c exec/exec_multi_pipe_utils.c exec/exec_errors_multi_pipe.c exec/here_doc.c exec/here_doc_utils.c exec/exec_checks.c
